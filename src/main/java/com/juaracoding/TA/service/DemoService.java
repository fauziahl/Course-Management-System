...
import com.juaracoding.TA.repo.DemoRepo;
...
//    public Map<String, Object> saveDemo(Demo demo, WebRequest request,MultipartFile filez) {
    public Map<String, Object> saveDemo(Demo demo,MultipartFile filez) {
...
//                        HttpStatus.NOT_ACCEPTABLE,null,"FV11001",request);
                        HttpStatus.NOT_ACCEPTABLE,null,"FV11001",null);
            }
