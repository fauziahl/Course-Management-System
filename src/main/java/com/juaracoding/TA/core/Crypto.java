package com.juaracoding.TA.core;
...
public class Crypto {
    ...
    public static void main(String[] args) {
        ...
        String strToEncrypt = "ubahSchedule";//put text to encrypt in here
        String encryptionResult = new Crypto().performEncrypt(strToEncrypt);
        System.out.println("Encryption Result : "+encryptionResult);

        String strToDecrypt = "$2a$11$mqMlvkC4aAbuGwkdJUDpH.vNpMpE.wOScIdWjbS5gSgvzxnG4VEMa";//put text to decrypt in here
