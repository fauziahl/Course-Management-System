...
//    public final static String ERROR_DATE_FORMAT_DDMMYYYY = "FORMAT TANGGAL TIDAK SESUAI (dd-MM-YYYY)";
    ...
    /*
        STUDENT
    */
    public final static String WARNING_STUDENT_NOT_EXISTS = "STUDENT TIDAK DOTEMUKAN";

    /*
        CLASSGROUP
    */
    public final static String ERROR_CLASSGROUP_NOT_AVAILABLE = "CLASS GROUP SUDAH ADA";
